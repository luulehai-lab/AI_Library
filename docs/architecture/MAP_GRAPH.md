...
graph TD
    ...
    backend_database_init_db ==>|calls| backend_database_get_db_connection
    backend_database_run_database_cleanup ==>|calls| backend_database_get_db_connection
    backend_database_add_book ==>|calls| backend_database_get_db_connection
    backend_database_add_book ==>|calls| backend_data_model_get_db_columns
    backend_database_get_book_by_id ==>|calls| backend_database_get_db_connection
    backend_database_get_filtered_books ==>|calls| backend_database_get_db_connection
    backend_database_update_book_field ==>|calls| backend_database_get_db_connection
    backend_database_delete_book ==>|calls| backend_database_get_db_connection
    backend_database_get_distinct_column_values ==>|calls| backend_database_get_db_connection
    backend_database_get_library_stats ==>|calls| backend_database_get_db_connection
    backend_database_get_dashboard_stats ==>|calls| backend_database_get_db_connection
...
graph TD
    ...
    frontend_main_window_ExcelExportWorker["🧩 ExcelExportWorker"]:::cls
    frontend_main_window_MainWindow["🧩 MainWindow"]:::cls
    frontend_main_window_ExcelExportWorker___init__["⚙️ __init__()"]:::func
    frontend_main_window_ExcelExportWorker_run["⚙️ run()"]:::func
    ...
    frontend_main_window_MainWindow_setup_banner_area["⚙️ setup_banner_area()"]:::func
    frontend_main_window_MainWindow_add_banner_images["⚙️ add_banner_images()"]:::func
    frontend_main_window_MainWindow_clear_banner_images["⚙️ clear_banner_images()"]:::func
    frontend_main_window_MainWindow_load_banner_images["⚙️ load_banner_images()"]:::func
    frontend_main_window_MainWindow_on_header_clicked["⚙️ on_header_clicked()"]:::func
    frontend_main_window_MainWindow_setup_gallery_view["⚙️ setup_gallery_view()"]:::func
    ...
    frontend_main_window_MainWindow_update_gallery_view["⚙️ update_gallery_view()"]:::func
    ...
    frontend_main_window_MainWindow_show_book_details_from_gallery["⚙️ show_book_details_from_gallery()"]:::func
    ...
    frontend_main_window -->|contains| frontend_main_window_ExcelExportWorker
    frontend_main_window -->|contains| frontend_main_window_MainWindow
    frontend_main_window_ExcelExportWorker -->|contains| frontend_main_window_ExcelExportWorker___init__
    frontend_main_window_ExcelExportWorker -->|contains| frontend_main_window_ExcelExportWorker_run
    ...
    frontend_main_window_MainWindow -->|contains| frontend_main_window_MainWindow_setup_banner_area
    frontend_main_window_MainWindow -->|contains| frontend_main_window_MainWindow_add_banner_images
    frontend_main_window_MainWindow -->|contains| frontend_main_window_MainWindow_clear_banner_images
    frontend_main_window_MainWindow -->|contains| frontend_main_window_MainWindow_load_banner_images
    frontend_main_window_MainWindow -->|contains| frontend_main_window_MainWindow_on_header_clicked
    frontend_main_window_MainWindow -->|contains| frontend_main_window_MainWindow_setup_gallery_view
    ...
    frontend_main_window_MainWindow -->|contains| frontend_main_window_MainWindow_update_gallery_view
    ...
    frontend_main_window_MainWindow -->|contains| frontend_main_window_MainWindow_show_book_details_from_gallery
    ...
    frontend_main_window_MainWindow_update_gallery_view ==>|calls| frontend_widgets_GalleryItemWidget
    frontend_main_window_MainWindow_display_book_dialog ==>|calls| frontend_widgets_ClickableLabel
    frontend_main_window_MainWindow_export_to_excel ==>|calls| frontend_main_window_ExcelExportWorker
